...
/*
This module is responsible of Pattern Detection of forEach in Program Root. The module carries out the following task:

1) Detect the main Program Body for forEach patterns.
...
module.exports={
 analyzeForEachRootCode:function(code) {
    ...
    //Tool which searches if there are functions traversing the AST and lists them out: smanna Dec 2, 2017
    var fs = require('fs'),
