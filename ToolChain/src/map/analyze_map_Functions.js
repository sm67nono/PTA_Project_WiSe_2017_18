...
/*
This module is responsible of Pattern Detection of map function Declarations. The module carries out the following task:

1) Detect a function Declaration and check if has the map pattern.
