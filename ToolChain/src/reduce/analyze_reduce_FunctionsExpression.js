...
/*
This module is responsible of Pattern Detection of reduce function expressions. The module carries out the following task:

1) Detect a function expression and check if has the reduce pattern.
...
*/
module.exports = {
  analyzeReduceFunctionExpressionCode:function(code) {
    // 1
    console.log("Tool Module: Reduce Function Expression Signatures");
...
var createItrFilterTemplate = fs.readFileSync("reduce_frame.js", 'utf-8');
...
estraverse.traverse(filter_ast, {
  enter: function(filter_node)
  {
    ...
    if(filter_node.type==="VariableDeclarator" && filter_node.id.name==="val")
      {
      ...
      if(filter_node.type==="VariableDeclarator" && filter_node.id.name==="accumulator")
        {
      ...
      if(filter_node.type==="ExpressionStatement")
        {
            ...
            {
              if(filter_node.expression.left.name=="accumulator")
              {
    ...
    for(var loopCount=0;loopCount<functionBody.length;loopCount++)
    {
      ...
      estraverse.traverse(checkNode, {
          enter: function(nodelvl2,parent2){
           ...
           nodelvl2.init= { "type": "Identifier","name": "accumulator" };
           nodeChanged=true;
        ...
        enter: function(nodelvl2,parent2){
          if (nodelvl2.type === 'AssignmentExpression')
          {
            ...
            if(typeOfOp=='reduce')
            {
              ...
              {
                nodelvl2.right= { "type": "Identifier","name": "accumulator" };
                nodeChanged=true;
              }
              }
            }
                ...
                if(parent2==dataStore[getFromTemplateStore].parentSignature)
                {
                  ...
                  if(dataStore[getFromTemplateStore].arrayOperatedOn.type!="CallExpression")
                  {
                   ...
                   for (var key in nodelvl2 ) {
                    ...
                    nodelvl2.expression.right.name="accumulator";
